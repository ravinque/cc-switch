...
export const providersApi = {
  async getAll(appId: AppId): Promise<Record<string, Provider>> {
    return await backendInvoke("get_providers", { app: appId });
  },

  async getCurrent(appId: AppId): Promise<string> {
    return await backendInvoke("get_current_provider", { app: appId });
  },
  ...
  async add(
    ...
    return await backendInvoke("add_provider", { provider, app: appId, addToLive });
  },
  ...
  async update(
    ...
    return await backendInvoke("update_provider", {
      provider,
      app: appId,
      originalId,
    });
  ...
  async delete(id: string, appId: AppId): Promise<boolean> {
    return await backendInvoke("delete_provider", { id, app: appId });
  },
  ...
  async removeFromLiveConfig(id: string, appId: AppId): Promise<boolean> {
    return await backendInvoke("remove_provider_from_live_config", { id, app: appId });
  },

  async switch(id: string, appId: AppId): Promise<SwitchResult> {
    return await backendInvoke("switch_provider", { id, app: appId });
  },

  async importDefault(appId: AppId): Promise<boolean> {
    return await backendInvoke("import_default_config", { app: appId });
  },

  async importClaudeDesktopFromClaude(): Promise<number> {
    return await backendInvoke("import_claude_desktop_providers_from_claude");
  },

  async ensureClaudeDesktopOfficialProvider(): Promise<boolean> {
    return await backendInvoke("ensure_claude_desktop_official_provider");
  },

  async getClaudeDesktopStatus(): Promise<ClaudeDesktopStatus> {
    return await backendInvoke("get_claude_desktop_status");
  },

  async getClaudeDesktopDefaultRoutes(): Promise<ClaudeDesktopDefaultRoute[]> {
    return await backendInvoke("get_claude_desktop_default_routes");
  },

  async updateTrayMenu(): Promise<boolean> {
    return await backendInvoke("update_tray_menu");
  },
  ...
  async updateSortOrder(
    ...
    return await backendInvoke("update_providers_sort_order", { updates, app: appId });
  },
  ...
  async openTerminal(
    ...
    const { cwd } = options ?? {};
    return await backendInvoke("open_provider_terminal", {
      providerId,
      app: appId,
      cwd,
    });
  ...
  async importOpenCodeFromLive(): Promise<number> {
    return await backendInvoke("import_opencode_providers_from_live");
  },
  ...
  async getOpenCodeLiveProviderIds(): Promise<string[]> {
    return await backendInvoke("get_opencode_live_provider_ids");
  },
  ...
  async getOpenClawLiveProviderIds(): Promise<string[]> {
    return await backendInvoke("get_openclaw_live_provider_ids");
  },
  ...
  async getHermesLiveProviderIds(): Promise<string[]> {
    return await backendInvoke("get_hermes_live_provider_ids");
  },
  ...
  async importOpenClawFromLive(): Promise<number> {
    return await backendInvoke("import_openclaw_providers_from_live");
  },
  ...
  async importHermesFromLive(): Promise<number> {
    return await backendInvoke("import_hermes_providers_from_live");
  },
};
...
export const universalProvidersApi = {
  ...
  async getAll(): Promise<UniversalProvidersMap> {
    return await backendInvoke("get_universal_providers");
  },
  ...
  async get(id: string): Promise<UniversalProvider | null> {
    return await backendInvoke("get_universal_provider", { id });
  },
  ...
  async upsert(provider: UniversalProvider): Promise<boolean> {
    return await backendInvoke("upsert_universal_provider", { provider });
  },
  ...
  async delete(id: string): Promise<boolean> {
    return await backendInvoke("delete_universal_provider", { id });
  },
  ...
  async sync(id: string): Promise<boolean> {
    return await backendInvoke("sync_universal_provider", { id });
  },
};
